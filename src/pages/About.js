    ...
    <div>
      ...
      <div className='about'>
        <p>
          ...
          <br /><br />
          Most of my development time, apart from course work is spent on my game engine that I use to make games with. Storywriting
          is my favorite thing and among others, I like games as a format. Because unlike other formats, they are interactive and placing yourself as
          the protagonist is nothing like YA self-inserts.
          <br /><br />
